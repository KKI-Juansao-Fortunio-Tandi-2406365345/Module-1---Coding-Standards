...
import org.springframework.test.context.bean.override.mockito.MockitoBean; // New standard for Spring Boot 3.4
...
class OrderControllerTest {
    ...
    @MockitoBean // Replaced @MockBean to remove the warning
